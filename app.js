...
window.onload = () => { 
    ...
    setInterval(() => { 
        try {
            if(localAuth.isAuth) {
                renderTables(); // Таймер столов (секунды онлайн)
                renderOnlineAdmins();
                renderGlobalStats();
...
function getCurrentShiftData() {
    ...
    // ФИКС ДЛЯ СМЕНЫ (Жесткая отсечка 20 марта 2026, 14:00:00)
...
function renderGlobalStats() {
    ...
    // Подсчитываем долги всем админам
