...
function getShiftStartTime() {
    ...
    // ЖЕСТКИЙ ФИКС ДЛЯ СМЕНЫ СУЛТАНА (с 21 марта 16:36)
    let fakeStart = new Date(2026, 2, 21, 16, 36, 0).getTime();
...
// ИСПРАВЛЕНИЕ: КНОПКИ АВАНСА И ШТРАФА (Защита от сбоев)
